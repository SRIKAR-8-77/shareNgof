...
const TravelPollsPage = () => {
  ...
  const fetchPolls = async () => {
    try {
      const res = await axios.get("https://sharengob.onrender.com/api/travel-polls", {
    ...
    if (destination && date && description && currentUser) {
      ...
      try {
        const response = await axios.post(
          "https://sharengob.onrender.com/api/travel-polls",
          newPoll,
          {
            headers: {
  ...
  const handleVote = async (id) => {
    try {
      await axios.put(
        `https://sharengob.onrender.com/api/travel-polls/${id}/vote`,
        {},
        {
          withCredentials: true,
        }
